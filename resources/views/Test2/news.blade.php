            ...
            <div class="content-news">
                ...
                <div class="news-block tab active" id="all-news">
                    ...
                    @foreach($news as $new)
                        <div class="news-click">
                            <p><span class="date">{{$new->date}}</span><span
                                    class="hot">[{{$new->prefix}}]</span> {{$new->subject}}  </p>
                        </div>
                        <div class="textnews">
                            <p>{!! $new-> news !!} </p>
                        </div>
                ...
                <div class="news-block tab" id="all-events">
                    @foreach($events as $event)
                        <div class="news-click">
                            <p><span class="date">{{$event->date}}</span><span
                                    class="hot">[{{$event->prefix}}]</span> {{$event->subject}}  </p>
                        </div>
                        <div class="textnews">
                            <p>{!! $event-> news !!} </p>
                        </div>
                ...
                <div class="news-block tab" id="all-updates">
                    @foreach($updates as $update)
                        <div class="news-click">
                            <p><span class="date">{{$update->date}}</span><span
                                    class="hot">[{{$update->prefix}}]</span> {{$update->subject}}  </p>
                        </div>
                        <div class="textnews">
                            <p>{!! $update-> news !!} </p>
                        </div>
