        ...
        <div class="{{$background}}">
            <div class="user-panel">
                <ul>
                    ...
                    <li>Status @if($status == 'Online') <span style="color: #00bb00"> Online </span> @else <span
                            style="color: #7c151f"> Offline </span> @endif</li>
                    <li>Location: {!! $map !!} ({{$user->MapPosX}},{{$user->MapPosY}})
                        <span>Kills: {{$user->PkCount}}</span></li>
                </ul>
            </div>
        </div>
