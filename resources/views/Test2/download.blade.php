...
@section('content')
    ...
    <main class="content">
        ...
        <div class="download-links-block">
            <a data-tab="lite" class="download-link active">Lite Version</a> <a data-tab="full" class="download-link">Full
                Version</a>
        </div>
        @if(isset($lite))
        ...
        <div class="block-p update-block">
            ...
            <p>If you have problems with the previous version of the launcher, <br> please extract this patch in the
                game folder to correct.</p>
