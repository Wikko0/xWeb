...
class Controller extends BaseController
{
    ...
    public function __construct() {
        ...
        $hof = XWEB_CHARACTERS::get();
        $characters = XWEB_CHARACTERS::get();
        View::share(['admin' => $admin,'adminname' => $adminname, 'announce' => $announce, 'download' => $download, 'event' => $event, 'boss' => $boss, 'slider' => $slider, 'hof' => $hof, 'characters' => $characters]);
